...
function ExpenseTracker() {
  ...
  const filteredTotal = useMemo(() => {
    ...
    return filteredTransactions.reduce((acc, curr) => {
      // Logic: If looking at a category, typically we want to know how much we spent (or earned)
      // We sum based on type. Income adds, Expense subtracts from a "Net" perspective,
      // But if user filters "Food" (Expense), showing positive number is often more readable.
      // Let's stick to true net flow for consistency: Income - Expense.
